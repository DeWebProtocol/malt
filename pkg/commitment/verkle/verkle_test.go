// Package verkle_test provides tests for the Verkle commitment implementation.
package verkle_test

import (
	"testing"

	"github.com/dewebprotocol/malt/pkg/commitment/verkle"
	"github.com/dewebprotocol/malt/pkg/types"
)

func TestVerkleCommitment_Commit(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
...
func TestVerkleCommitment_ProveVerify(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
...
func TestVerkleCommitment_Update(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
...
func TestVerkleCommitment_BatchUpdate(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
...
func TestVerkleCommitment_InvalidUpdate(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
...
func TestVerkleCommitment_PathNotFound(t *testing.T) {
	scheme, err := verkle.New(nil)
	if err != nil {
		t.Fatalf("Failed to create Verkle scheme: %v", err)
	}
