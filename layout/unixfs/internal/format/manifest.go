...
// CodecMaltManifest is the UnixFS layout manifest CID codec.
...
// IsManifestCID reports whether c is a UnixFS layout manifest CID.
func IsManifestCID(c cid.Cid) bool {
	return c.Defined() && c.Prefix().Codec == CodecMaltManifest
}

// CodecName returns the locked wire name for UnixFS layout codecs.
