...
// DirectoryRootBindings builds the HTTP create-structure bindings for a
// materialized UnixFS directory root. Direct children are included by name, and
...
// CountDefinedBindings counts non-empty targets in a create-structure binding
// map.
