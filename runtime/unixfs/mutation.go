...
type MutationPlan = unixfsmodel.MutationPlan
type MutationDelta = unixfsmodel.MutationDelta
type FixedListCommit = unixfsmodel.FixedListCommit
...
func (l *Adapter) MutationPlanForPath(ctx context.Context, root cid.Cid, path string) (*MutationPlan, error) {
	if !root.Defined() {
...
// root map.
func (l *Adapter) MutationPlanForRoot(ctx context.Context, baseRoot cid.Cid, root cid.Cid) (*MutationPlan, error) {
	if !root.Defined() {
		return nil, fmt.Errorf("root is undefined")
	}
...
func (l *Adapter) appendRootMutationDeltas(ctx context.Context, plan *MutationPlan, oldNodeRoot, nodeRoot cid.Cid) error {
...
func (l *Adapter) appendRootCreationDeltas(ctx context.Context, plan *MutationPlan, nodeRoot cid.Cid) error {
	kind, err := l.nodeType(ctx, nodeRoot)
	if err != nil {
		return err
	}
...
func (l *Adapter) canonicalNodeArcSet(ctx context.Context, nodeRoot cid.Cid, kind string) (*arcset.CanonicalArcSet, error) {
...
func (l *Adapter) canonicalListArcSet(ctx context.Context, root cid.Cid, length uint64) (*arcset.CanonicalArcSet, error) {
...
func (l *Adapter) appendListMutationDelta(ctx context.Context, plan *MutationPlan, oldPayload cid.Cid, oldInfo *fileInfo, payload cid.Cid, info *fileInfo) error {
...
func (l *Adapter) fixedListCommitForPayload(ctx context.Context, payload cid.Cid, info *fileInfo) (*FixedListCommit, error) {
