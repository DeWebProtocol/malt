...
func init() {
	...
	initCmd.Flags().StringVar(&initRPCListen, "listen", "", "reference-executor listen address")
...
func runInit(cmd *cobra.Command, args []string) error {
	...
	cfg.RPC.Listen = promptString(reader, "Reference-executor listen", initRPCListen, cfg.RPC.Listen, initNonInteractive)
	...
	fmt.Fprintf(os.Stdout, "reference executor API: %s\n", cfg.APIBaseURL())
