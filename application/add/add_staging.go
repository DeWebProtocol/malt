...
func materializeSymlinkDirectoryBoundary(ctx context.Context, remote projectionWriter, casClient addCASClient, localPath string, seen map[string]struct{}) (cid.Cid, int, int64, *addMaterializeResult, int, error) {
...
func stageHierarchicalDirectoryChildren(ctx context.Context, root *unixfs.StagedNode, casClient addCASClient, remote projectionWriter, localDir string, mountBase string, seen map[string]struct{}) (int, int64, int, *addMaterializeResult, int, error) {
...
func buildAddStagingTree(ctx context.Context, casClient addCASClient, remote projectionWriter, rawInputs []string, opts addBuildOptions) (*addBuildResult, error) {
...
func stageDirectoryInput(ctx context.Context, root *unixfs.StagedNode, casClient addCASClient, remote projectionWriter, item addMountedInput, ignoreOpts addIgnoreOptions) (int, int64, int, *addMaterializeResult, int, error) {
...
func stageSingleFile(ctx context.Context, root *unixfs.StagedNode, casClient addCASClient, remote projectionWriter, localPath string, targetPath string) (int64, int, error) {
	if err := validateStagedPath(targetPath); err != nil {
